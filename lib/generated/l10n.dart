...
class S {
  ...
  String get accountNull {
    return Intl.message('Please enter your account', name: 'accountNull', desc: '', args: []);
  }

  /// `Please enter the password`
  String get passwordNull {
    return Intl.message('Please enter the password', name: 'passwordNull', desc: '', args: []);
  }
  ...
  String get alertError {
    return Intl.message('An error occurred', name: 'alertError', desc: '', args: []);
  }

  /// ` Download error`
  String get downloadError {
    return Intl.message(' Download error', name: 'downloadError', desc: '', args: []);
  }

  /// `Is a link`
  String get isALink {
    return Intl.message('Is a link', name: 'isALink', desc: '', args: []);
  }
  ...
  String get downloadComplete {
    return Intl.message('Download complete', name: 'downloadComplete', desc: '', args: []);
  }
  ...
  String get unknownError {
    return Intl.message('An unknown error occurred', name: 'unknownError', desc: '', args: []);
  }
  ...
  String get loginScore {
    return Intl.message('Login to Score...', name: 'loginScore', desc: '', args: []);
  }

  /// `Login to Score Error`
  String get loginScoreError {
    return Intl.message('Login to Score Error', name: 'loginScoreError', desc: '', args: []);
  }
  ...
  String get getCourse {
    return Intl.message('Get schedule...', name: 'getCourse', desc: '', args: []);
  }

  /// `Getting schedule error`
  String get getCourseError {
    return Intl.message('Getting schedule error', name: 'getCourseError', desc: '', args: []);
  }

  /// `Login course system...`
  String get loginCourse {
    return Intl.message('Login course system...', name: 'loginCourse', desc: '', args: []);
  }

  /// `Login course system error`
  String get loginCourseError {
    return Intl.message('Login course system error', name: 'loginCourseError', desc: '', args: []);
  }

  /// `Get semester list...`
  String get getCourseSemester {
    return Intl.message('Get semester list...', name: 'getCourseSemester', desc: '', args: []);
  }

  /// `Getting semester list error`
  String get getCourseSemesterError {
    return Intl.message('Getting semester list error', name: 'getCourseSemesterError', desc: '', args: []);
  }

  /// `Reading course materials...`
  String get getCourseDetail {
    return Intl.message('Reading course materials...', name: 'getCourseDetail', desc: '', args: []);
  }
  ...
  String get getISchoolPlusCourseFile {
    return Intl.message('Get course files', name: 'getISchoolPlusCourseFile', desc: '', args: []);
  }

  /// `Get course files error`
  String get getISchoolPlusCourseFileError {
    return Intl.message('Get course files error', name: 'getISchoolPlusCourseFileError', desc: '', args: []);
  }

  /// `Get course announcement...`
  String get getISchoolPlusCourseAnnouncement {
    return Intl.message('Get course announcement...', name: 'getISchoolPlusCourseAnnouncement', desc: '', args: []);
  }
  ...
  String get getScoreRank {
    return Intl.message('Getting the grades...', name: 'getScoreRank', desc: '', args: []);
  }

  /// `There's an error getting the grades`
  String get getScoreRankError {
    return Intl.message('There\'s an error getting the grades', name: 'getScoreRankError', desc: '', args: []);
  }
  ...
  String get getCalendar {
    return Intl.message('Getting calendar...', name: 'getCalendar', desc: '', args: []);
  }

  /// `Getting calendar error`
  String get getCalendarError {
    return Intl.message('Getting calendar error', name: 'getCalendarError', desc: '', args: []);
  }

  /// `Getting student list...`
  String get getStudentList {
    return Intl.message('Getting student list...', name: 'getStudentList', desc: '', args: []);
  }
  ...
  String get pleaseEnterStudentId {
    return Intl.message('Please enter student number', name: 'pleaseEnterStudentId', desc: '', args: []);
  }
  ...
  String get noAnyFavorite {
    return Intl.message('No any favorite', name: 'noAnyFavorite', desc: '', args: []);
  }

  /// `Setting complete`
  String get settingComplete {
    return Intl.message('Setting complete', name: 'settingComplete', desc: '', args: []);
  }
  ...
  String get findNewMessage {
    return Intl.message('Find I Plus new message', name: 'findNewMessage', desc: '', args: []);
  }

  /// `Search credit`
  String get searchCredit {
    return Intl.message('Search credit', name: 'searchCredit', desc: '', args: []);
  }

  /// `Search credit...`
  String get searchingCredit {
    return Intl.message('Search credit...', name: 'searchingCredit', desc: '', args: []);
  }
  ...
  String get loadFavorite {
    return Intl.message('Load favorite', name: 'loadFavorite', desc: '', args: []);
  }

  /// `Set as android weight`
  String get setAsAndroidWeight {
    return Intl.message('Set as android weight', name: 'setAsAndroidWeight', desc: '', args: []);
  }

  /// `Select semester`
  String get selectSemester {
    return Intl.message('Select semester', name: 'selectSemester', desc: '', args: []);
  }
  ...
  String get createNewFolder {
    return Intl.message('Create New folder', name: 'createNewFolder', desc: '', args: []);
  }

  /// `Create Folder`
  String get createFolder {
    return Intl.message('Create Folder', name: 'createFolder', desc: '', args: []);
  }

  /// `There's nothing here`
  String get nothingHere {
    return Intl.message('There\'s nothing here', name: 'nothingHere', desc: '', args: []);
  }

  /// `Cannot write to this Storage device!`
  String get cannotWrite {
    return Intl.message('Cannot write to this Storage device!', name: 'cannotWrite', desc: '', args: []);
  }

  /// `A Folder with that name already exists!`
  String get folderNameAlreadyExists {
    return Intl.message('A Folder with that name already exists!', name: 'folderNameAlreadyExists', desc: '', args: []);
  }

  /// `A File with that name already exists!`
  String get fileNameAlreadyExists {
    return Intl.message('A File with that name already exists!', name: 'fileNameAlreadyExists', desc: '', args: []);
  }

  /// `Rename item`
  String get renameItem {
    return Intl.message('Rename item', name: 'renameItem', desc: '', args: []);
  }
  ...
  String get closeOnce {
    return Intl.message('Press again to close', name: 'closeOnce', desc: '', args: []);
  }
  ...
  String get downloadPath {
    return Intl.message('Download path', name: 'downloadPath', desc: '', args: []);
  }

  /// `Developer Mode`
  String get developerMode {
    return Intl.message('Developer Mode', name: 'developerMode', desc: '', args: []);
  }

  /// `Open with external video player`
  String get openExternalVideo {
    return Intl.message('Open with external video player', name: 'openExternalVideo', desc: '', args: []);
  }

  /// `Recommend use MX player`
  String get openExternalVideoHint {
    return Intl.message('Recommend use MX player', name: 'openExternalVideoHint', desc: '', args: []);
  }
  ...
  String get informationSystem {
    return Intl.message('Information System', name: 'informationSystem', desc: '', args: []);
  }
  ...
  String get announcement {
    return Intl.message('Announcement', name: 'announcement', desc: '', args: []);
  }

  /// `File and Videos`
  String get fileAndVideo {
    return Intl.message('File and Videos', name: 'fileAndVideo', desc: '', args: []);
  }
  ...
  String get noAnyFile {
    return Intl.message('No files', name: 'noAnyFile', desc: '', args: []);
  }
  ...
  /// `Syllabus`
  String get syllabus {
    return Intl.message('Syllabus', name: 'syllabus', desc: '', args: []);
  }
  ...
  String get classroomUse {
    return Intl.message('classroomUse', name: 'classroomUse', desc: '', args: []);
  }

  /// `Number of students`
  String get numberOfStudent {
    return Intl.message('Number of students', name: 'numberOfStudent', desc: '', args: []);
  }

  /// `Number of withdraw`
  String get numberOfWithdraw {
    return Intl.message('Number of withdraw', name: 'numberOfWithdraw', desc: '', args: []);
  }

  /// `Course Information`
  String get courseData {
    return Intl.message('Course Information', name: 'courseData', desc: '', args: []);
  }
  ...
  String get willRestart {
    return Intl.message('Will restart automatically', name: 'willRestart', desc: '', args: []);
  }
  ...
  /// `Is a video`
  String get isVideo {
    return Intl.message('Is a video', name: 'isVideo', desc: '', args: []);
  }

  /// `class video`
  String get classVideo {
    return Intl.message('class video', name: 'classVideo', desc: '', args: []);
  }

  /// `Search subscribe...`
  String get searchSubscribe {
    return Intl.message('Search subscribe...', name: 'searchSubscribe', desc: '', args: []);
  }

  /// `Open subscribe`
  String get openSubscribe {
    return Intl.message('Open subscribe', name: 'openSubscribe', desc: '', args: []);
  }

  /// `Close subscribe`
  String get closeSubscribe {
    return Intl.message('Close subscribe', name: 'closeSubscribe', desc: '', args: []);
  }
  ...
  String get identifyLinks {
    return Intl.message('Identify links', name: 'identifyLinks', desc: '', args: []);
  }

  /// `This course does not support queries`
  String get iPlusNoThisClass {
    return Intl.message('This course does not support queries', name: 'iPlusNoThisClass', desc: '', args: []);
  }
  ...
  String get projectLink {
    return Intl.message('Project link', name: 'projectLink', desc: '', args: []);
  }
  ...
  String get Contributors {
    return Intl.message('Contributors', name: 'Contributors', desc: '', args: []);
  }
  ...
  String get searchScore {
    return Intl.message('Search score', name: 'searchScore', desc: '', args: []);
  }

  /// `Calculation credit`
  String get calculationCredit {
    return Intl.message('Calculation credit', name: 'calculationCredit', desc: '', args: []);
  }

  /// `Credit Summary`
  String get creditSummary {
    return Intl.message('Credit Summary', name: 'creditSummary', desc: '', args: []);
  }

  /// `Compulsory Compulsory`
  String get compulsoryCompulsory {
    return Intl.message('Compulsory Compulsory', name: 'compulsoryCompulsory', desc: '', args: []);
  }

  /// `Revised Common Compulsory`
  String get revisedCommonCompulsory {
    return Intl.message('Revised Common Compulsory', name: 'revisedCommonCompulsory', desc: '', args: []);
  }

  /// `Joint elective`
  String get jointElective {
    return Intl.message('Joint elective', name: 'jointElective', desc: '', args: []);
  }

  /// `Compulsory professional`
  String get compulsoryProfessional {
    return Intl.message('Compulsory professional', name: 'compulsoryProfessional', desc: '', args: []);
  }

  /// `Compulsory major revision`
  String get compulsoryMajorRevision {
    return Intl.message('Compulsory major revision', name: 'compulsoryMajorRevision', desc: '', args: []);
  }

  /// `Professional Electives`
  String get professionalElectives {
    return Intl.message('Professional Electives', name: 'professionalElectives', desc: '', args: []);
  }

  /// `General lesson summary`
  String get generalLessonSummary {
    return Intl.message('General lesson summary', name: 'generalLessonSummary', desc: '', args: []);
  }

  /// `Take core`
  String get takeCore {
    return Intl.message('Take core', name: 'takeCore', desc: '', args: []);
  }

  /// `Take select`
  String get takeSelect {
    return Intl.message('Take select', name: 'takeSelect', desc: '', args: []);
  }

  /// `Foreign Dep Credits`
  String get takeForeignDepartmentCredits {
    return Intl.message('Foreign Dep Credits', name: 'takeForeignDepartmentCredits', desc: '', args: []);
  }

  /// `Credit limit`
  String get takeForeignDepartmentCreditsLimit {
    return Intl.message('Credit limit', name: 'takeForeignDepartmentCreditsLimit', desc: '', args: []);
  }
  ...
  String get resultsOfVariousSubjects {
    return Intl.message('Results of various subjects', name: 'resultsOfVariousSubjects', desc: '', args: []);
  }

  /// `Semester grades`
  String get semesterGrades {
    return Intl.message('Semester grades', name: 'semesterGrades', desc: '', args: []);
  }

  /// `Total average`
  String get totalAverage {
    return Intl.message('Total average', name: 'totalAverage', desc: '', args: []);
  }

  /// `Performance scores`
  String get performanceScores {
    return Intl.message('Performance scores', name: 'performanceScores', desc: '', args: []);
  }

  /// `Practice credit`
  String get practiceCredit {
    return Intl.message('Practice credit', name: 'practiceCredit', desc: '', args: []);
  }

  /// `Credits earned`
  String get creditsEarned {
    return Intl.message('Credits earned', name: 'creditsEarned', desc: '', args: []);
  }

  /// `No rank information`
  String get noRankInfo {
    return Intl.message('No rank information', name: 'noRankInfo', desc: '', args: []);
  }

  /// `Semester ranking`
  String get semesterRanking {
    return Intl.message('Semester ranking', name: 'semesterRanking', desc: '', args: []);
  }

  /// `Previous rankings`
  String get previousRankings {
    return Intl.message('Previous rankings', name: 'previousRankings', desc: '', args: []);
  }
  ...
  String get searchingYear {
    return Intl.message('Searching year', name: 'searchingYear', desc: '', args: []);
  }

  /// `Searching division`
  String get searchingDivision {
    return Intl.message('Searching division', name: 'searchingDivision', desc: '', args: []);
  }

  /// `Searching department`
  String get searchingDepartment {
    return Intl.message('Searching department', name: 'searchingDepartment', desc: '', args: []);
  }

  /// `Searching credit`
  String get searchingCreditInfo {
    return Intl.message('Searching credit', name: 'searchingCreditInfo', desc: '', args: []);
  }

  /// `Graduation credit standard setting`
  String get graduationSetting {
    return Intl.message('Graduation credit standard setting', name: 'graduationSetting', desc: '', args: []);
  }
  ...
  /// `class`
  String get kClass {
    return Intl.message('class', name: 'kClass', desc: '', args: []);
  }

  /// `department`
  String get kDepartment {
    return Intl.message('department', name: 'kDepartment', desc: '', args: []);
  }

  /// `Unknown Department`
  String get unknownDepartment {
    return Intl.message('Unknown Department', name: 'unknownDepartment', desc: '', args: []);
  }

  /// `Unknown Student`
  String get unknownStudent {
    return Intl.message('Unknown Student', name: 'unknownStudent', desc: '', args: []);
  }
  ...
  String get nationalTaipeiUniversity {
    return Intl.message('NTPU', name: 'nationalTaipeiUniversity', desc: '', args: []);
  }

  /// `TMU`
  String get taipeiMedicineUniversity {
    return Intl.message('TMU', name: 'taipeiMedicineUniversity', desc: '', args: []);
  }

  /// `Aduit`
  String get aduit {
    return Intl.message('Aduit', name: 'aduit', desc: '', args: []);
  }
}
