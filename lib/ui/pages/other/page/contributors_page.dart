...
class ContributorsPage extends StatelessWidget {
  final github = GitHub();
  final repositorySlug = RepositorySlug(AppLink.githubOwnerName, AppLink.repoName);
            ...
            Row(
              children: [
                Expanded(
                  child: InkWell(
                    onTap: () {
                      const url = AppLink.githubRepoUrlString;
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(children: const [Expanded(child: Text(AppLink.githubRepoUrlString))]),
                        ],
                      ),
                    ),
                  ),
