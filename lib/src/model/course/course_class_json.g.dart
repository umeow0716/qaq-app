...
CourseMainJson _$CourseMainJsonFromJson(Map<String, dynamic> json) => CourseMainJson(
  ...
  time: (json['time'] as Map<String, dynamic>?)?.map((k, e) => MapEntry($enumDecode(_$DayEnumMap, k), e as String)),
...
ClassJson _$ClassJsonFromJson(Map<String, dynamic> json) =>
    ClassJson(name: json['name'] as String?, href: json['href'] as String?);
...
TeacherJson _$TeacherJsonFromJson(Map<String, dynamic> json) =>
    TeacherJson(name: json['name'] as String?, href: json['href'] as String?);
...
SemesterJson _$SemesterJsonFromJson(Map<String, dynamic> json) =>
    SemesterJson(year: json['year'] as String?, semester: json['semester'] as String?);
