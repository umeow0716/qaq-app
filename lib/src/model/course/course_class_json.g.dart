...
CourseMainJson _$CourseMainJsonFromJson(Map<String, dynamic> json) => CourseMainJson(
...
CourseExtraJson _$CourseExtraJsonFromJson(Map<String, dynamic> json) => CourseExtraJson(
      id: json['id'] as String?,
      name: json['name'] as String?,
...
Map<String, dynamic> _$ClassJsonToJson(ClassJson instance) => <String, dynamic>{'name': instance.name, 'href': instance.href};

ClassroomJson _$ClassroomJsonFromJson(Map<String, dynamic> json) => ClassroomJson(
      name: json['name'] as String?,
      href: json['href'] as String?,
...
Map<String, dynamic> _$ClassroomJsonToJson(ClassroomJson instance) =>
    <String, dynamic>{'name': instance.name, 'href': instance.href, 'mainUse': instance.mainUse};
...
Map<String, dynamic> _$TeacherJsonToJson(TeacherJson instance) => <String, dynamic>{'name': instance.name, 'href': instance.href};
...
ClassmateJson _$ClassmateJsonFromJson(Map<String, dynamic> json) => ClassmateJson(
