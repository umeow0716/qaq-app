...
CourseScoreCreditJson _$CourseScoreCreditJsonFromJson(Map<String, dynamic> json) => CourseScoreCreditJson(
      ...
      semesterCourseScoreList: (json['semesterCourseScoreList'] as List<dynamic>?)
          ?.map((e) => SemesterCourseScoreJson.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$CourseScoreCreditJsonToJson(CourseScoreCreditJson instance) => <String, dynamic>{
      'graduationInformation': instance.graduationInformation,
      'semesterCourseScoreList': instance.semesterCourseScoreList,
    };

GraduationInformationJson _$GraduationInformationJsonFromJson(Map<String, dynamic> json) => GraduationInformationJson(
      lowCredit: json['lowCredit'] as int?,
      courseTypeMinCredit: (json['courseTypeMinCredit'] as Map<String, dynamic>?)?.map((k, e) => MapEntry(k, e as int)),
...
Map<String, dynamic> _$GraduationInformationJsonToJson(GraduationInformationJson instance) => <String, dynamic>{
...
SemesterCourseScoreJson _$SemesterCourseScoreJsonFromJson(Map<String, dynamic> json) => SemesterCourseScoreJson(
...
Map<String, dynamic> _$SemesterCourseScoreJsonToJson(SemesterCourseScoreJson instance) => <String, dynamic>{
...
RankJson _$RankJsonFromJson(Map<String, dynamic> json) => RankJson(
      course: json['course'] == null ? null : RankItemJson.fromJson(json['course'] as Map<String, dynamic>),
      department: json['department'] == null ? null : RankItemJson.fromJson(json['department'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$RankJsonToJson(RankJson instance) =>
    <String, dynamic>{'course': instance.course, 'department': instance.department};
...
Map<String, dynamic> _$RankItemJsonToJson(RankItemJson instance) =>
    <String, dynamic>{'rank': instance.rank, 'total': instance.total, 'percentage': instance.percentage};

CourseScoreInfoJson _$CourseScoreInfoJsonFromJson(Map<String, dynamic> json) => CourseScoreInfoJson(
...
Map<String, dynamic> _$CourseScoreInfoJsonToJson(CourseScoreInfoJson instance) => <String, dynamic>{
