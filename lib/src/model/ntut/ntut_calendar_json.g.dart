...
NTUTCalendarJson _$NTUTCalendarJsonFromJson(Map<String, dynamic> json) => NTUTCalendarJson(
      json['id'] as int?,
      ...
      json['calInviteeList'] as List<dynamic>?,
      json['calAlertList'] as List<dynamic>?,
    );
